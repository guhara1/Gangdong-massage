...
export const metadata: Metadata = {
  ...
  description:
    "강동 전 지역 출장마사지. 한국인 관리사 빠른 방문, 정찰제 요금·야간 예약. 지역·요금·준비사항 안내.",
  ...
  return (
    <div className="home">
      ...
      <header className="cover">
        <div className="wrap">
          <p className="eyebrow">강동구 전 지역 방문 케어</p>
          <h1 className="display">
            강동 <span className="accent">출장마사지</span>
            <br />
            예약 안내
          </h1>
          <p className="lead">
            방문 가능 여부, 요금, 예약 절차, 준비사항, 안전 이용 기준을 한 번에 확인하세요.
          </p>
      ...
      <section className="ed">
        <div className="wrap measure">
          ...
          <h2 className="head">강동 출장마사지, 예약 전에 알아두면 좋은 것</h2>
          <div className="ed-prose">
            <p className="lead dropcap">
              강동 출장마사지는 마사지 업소를 직접 찾아가는 대신, 관리사가 강동구 내 자택·숙소로 방문해 케어를
              진행하는 방문 웰니스 서비스입니다. 이동과 대기 없이 익숙한 공간에서 휴식할 수 있다는 점이 가장 큰
              장점이지만, 그만큼 예약 전에 지역·요금·안전 기준을 분명히 확인하는 것이 중요합니다.
            </p>
            <p>
              이 페이지는 강동구 9개 지역과 6가지 케어 유형을 한눈에 비교하고, 처음 이용하는 분도 기준을 갖고
              선택할 수 있도록 돕는 안내의 출발점입니다. 천천히 읽어 내려가며 내 상황에 맞는 케어와 지역을
              확인해 보세요.
            </p>
          </div>
        </div>
      ...
      <section className="ed">
        <div className="wrap">
          ...
          <h2 className="head">강동구 방문 가능 지역 선택</h2>
          <p className="ed-kicker">
            방문 가능한 강동구 9개 지역입니다. 지역을 선택하면 방문 가능 시간과 예약 팁을 확인할 수 있습니다.
          </p>
          <div className="area-chips" style={{ marginTop: 22 }}>
            {areas.map((a) => (
      ...
      <section className="ed">
        <div className="wrap">
          ...
          <h2 className="head">강동 출장마사지 서비스 유형</h2>
          <p className="ed-kicker">
            목적에 맞는 웰니스 케어를 선택하세요. 모두 휴식과 피로 관리를 위한 방문 케어입니다.
          </p>
      ...
      <section className="ed">
        <div className="wrap measure">
          <p className="eyebrow">예약 절차</p>
          <h2 className="head">예약은 이렇게 진행됩니다</h2>
          <ol className="step-list" style={{ marginTop: 24 }}>
            {steps.map((s) => (
              <li key={s.n}>
      ...
      <section className="ed">
        <div className="wrap">
          ...
          <h2 className="head">코스별 기본 요금</h2>
          <p className="ed-kicker">
      ...
      <section className="ed">
        <div className="wrap measure">
          <p className="eyebrow">안전</p>
          <blockquote className="pullquote">
            {trustNotice}
            <cite>안전하고 건전한 이용 기준</cite>
          </blockquote>
      ...
      <section className="ed">
        <div className="wrap">
          ...
          <h2 className="head">처음 이용하는 분을 위한 준비사항</h2>
          ...
          <p className="ed-kicker" style={{ marginTop: 18 }}>
      ...
      <section className="ed">
        <div className="wrap">
          <p className="eyebrow">지역 안내</p>
          <h2 className="head">강동구 지역별 출장마사지 안내</h2>
          <div className="grid grid-3" style={{ marginTop: 26 }}>
            {areas.map((a) => (
      ...
      {/* 실제 방문 팁 — 에디토리얼 */}
      <section className="ed">
        <div className="wrap measure ed-prose">
          <p className="eyebrow">방문 노트</p>
          <h2 className="head">실제 예약 전 확인하면 좋은 강동구 방문 팁</h2>
          <p>
            방문 케어는 건물 형태와 동선에 따라 진행이 매끄럽기도, 지연되기도 합니다. 강동구에서 실제 예약을
            준비할 때 미리 확인하면 좋은 점을 생활권별로 정리했습니다.
          </p>
          <h3>아파트 방문</h3>
          <p>
      ...
      <section className="ed">
        <div className="wrap measure">
          <p className="eyebrow">편집 기준</p>
          <h2 className="head">콘텐츠 작성 및 검수 기준</h2>
          ...
          <p className="ed-kicker" style={{ marginTop: 16 }}>
